const relicsData = {
  "horn-of-war": {
    ...
    isVertical: false,
    coverImage: null, // Add cover later when you have it
    sections: [
      {
        title: "THE SILENCE",
  ...
  "iron-collide": {
    ...
    isVertical: false,
    coverImage: "/1fe52410-6320-11f1-94f7-f3f3b6c0f03c.webp", // IRON COLLIDE ART
    sections: [
      {
        title: "THE FORGE",
  ...
  "crown-of-thorns": {
    ...
    isVertical: false,
    coverImage: null, // Add when ready
    sections: [
      {
        title: "THE MOCKERY",
  ...
  "lion-and-lamb": {
    ...
    isVertical: false,
    coverImage: "/e8a21b70-631f-11f1-94f7-f3f3b6c0f03c.webp", // SPIRITUAL JOURNEY ART
    sections: [
      {
        title: "THE LAMB",
  ...
  "blood-of-cross": {
    ...
    isVertical: true,
    coverImage: "/148e9d30-6320-11f1-94f7-f3f3b6c0f03c.webp", // BLOOD OF CROSS ART
    sections: [
      {
        title: "THE PRICE",
  ...
  "heaven-calling": {
    ...
    isVertical: true,
    coverImage: "/file_0000000065a071f5832301f52d11fb80.png", // SCARS THAT PREACH ART
    sections: [
      {
        title: "THE WHISPER",
