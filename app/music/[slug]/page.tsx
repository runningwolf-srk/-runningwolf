...
const relicsData = {
  "horn-of-war": {
    ...
    isVertical: false,
    coverImage: "/photo4027977513156513554.jpeg",
    sections: [
      {
        title: "THE SILENCE",
  ...
  "iron-collide": {
    ...
    isVertical: false,
    coverImage: "/1fe52410-6320-11f1-94f7-f3f3b6c0f03c.webp",
    sections: [
      {
        title: "THE FORGE",
  ...
  "crown-of-thorns": {
    ...
    isVertical: false,
    coverImage: "/photo3082345025137839641.jpeg",
    sections: [
      {
        title: "THE MOCKERY",
  ...
  "lion-and-lamb": {
    ...
    isVertical: false,
    coverImage: "/e8a21b70-631f-11f1-94f7-f3f3b6c0f03c.webp",
    sections: [
      {
        title: "THE LAMB",
  ...
  "heaven-calling": {
    ...
    isVertical: true,
    coverImage: "/photo7096196557556417083.jpeg",
    sections: [
      {
        title: "THE WHISPER",
